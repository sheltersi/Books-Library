        ...
        <form method="POST" action="{{ route('books.store') }}">
            ...
            <div class="mb-4">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3
                 ...
                 name="title" id="title" type="text" placeholder="book title">
              </div>
              @error('title')
...
@enderror
              ...
              <div class="mb-4">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3
                 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
                 name="author" id="author" type="text" placeholder="book author" required>
              </div>
              ...
              <div class="mb-4">
               ...
               Book Version
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3
                 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
                 name="version" id="version" type="text" placeholder="book version" required>
              </div>
              ...
              <div class="mb-4">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3
                 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
                 name="year_published" id="year_published" type="text" placeholder="year published" required>
              </div>
